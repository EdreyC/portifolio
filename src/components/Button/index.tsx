...
export function ButtonNavigateOutline(props: ButtonNavigateProps) {
    ...
    return (
        <Link to={props.to}>
             <div className="flex items-center flex-row  text-indigo-800 gap-3 p-3 rounded bg-none border-2 border-indigo-800">
               {props.children}
            </div>
...
export function ButtonLinkCircle(props: ButtonLinkProps) {
    ...
    return (
        <a href={props.link}>
             <div className="flex items-center flex-row bg-none text-indigo-800 border-slate-200 border dark:bg-indigo-800 dark:border-none dark:text-slate-50 gap-3 p-2 rounded-full">
               {props.children}
            </div>
